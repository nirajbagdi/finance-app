export const transactions = [
    ...
    {
        avatar: '/assets/avatars/savory-bites-bistro.jpg',
    ...
    {
        avatar: '/assets/avatars/daniel-carter.jpg',
        name: 'Daniel Carter',
        category: 'General',
    ...
    {
        avatar: '/assets/avatars/sun-park.jpg',
        name: 'Sun Park',
        category: 'General',
    ...
    {
        avatar: '/assets/avatars/urban-services-hub.jpg',
    ...
    {
        avatar: '/assets/avatars/liam-hughes.jpg',
        name: 'Liam Hughes',
        category: 'Groceries',
    ...
    {
        avatar: '/assets/avatars/lily-ramirez.jpg',
        name: 'Lily Ramirez',
        category: 'General',
    ...
    {
        avatar: '/assets/avatars/ethan-clark.jpg',
        name: 'Ethan Clark',
        category: 'Dining Out',
    ...
    {
        avatar: '/assets/avatars/ella-phillips.jpg',
        name: 'Ella Phillips',
        category: 'Dining Out',
    ...
    {
        avatar: '/assets/avatars/sofia-peterson.jpg',
        name: 'Sofia Peterson',
    ...
    {
        avatar: '/assets/avatars/mason-martinez.jpg',
        name: 'Mason Martinez',
        category: 'Lifestyle',
    ...
    {
        avatar: '/assets/avatars/sebastian-cook.jpg',
        name: 'Sebastian Cook',
        category: 'Transportation',
    ...
    {
        avatar: '/assets/avatars/william-harris.jpg',
        name: 'William Harris',
    ...
    {
        avatar: '/assets/avatars/rina-sato.jpg',
        name: 'Rina Sato',
        category: 'Bills',
    ...
    {
        avatar: '/assets/avatars/yuna-kim.jpg',
        name: 'Yuna Kim',
        category: 'Dining Out',
    ...
    {
        avatar: '/assets/avatars/flavor-fiesta.jpg',
        name: 'Flavor Fiesta',
        category: 'Dining Out',
    ...
    {
        avatar: '/assets/avatars/harper-edwards.jpg',
        name: 'Harper Edwards',
        category: 'Shopping',
